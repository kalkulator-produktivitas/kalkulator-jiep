<template>
  <div v-if="available" class="container grid lg:grid-rows-5 grid-rows-7 gap-4 relatives">

    <div class="lg:row-span-3 row-span-4 grid grid-cols-12 gap-4">
      <GraphKpiLine class="col-span-9" id="2" :dataset="lineData" :key="`line2-${reactiveState}`" />
    ...
    <div class="lg:row-span-2 row-span-3 grid grid-cols-12 gap-4">
      ...
      <div :key="`material-${reactiveState}`"
        ...
        <div class="my-auto w-[50%] flex">
          <Icon name="mdi:weight-kilogram" size="24mm" class="mx-auto mt-[70%] lg:my-auto flex-none text-[#034EA2]" />
        </div>
